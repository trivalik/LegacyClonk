...
gboolean C4ViewportWindow::OnKeyPressStatic(GtkWidget *widget, GdkEventKey *event, gpointer user_data)
{
	...
	switch (event->keyval)
	{
	case GDK_KEY_1: DDrawCfg.fBlitOff   -= 0.05; printf("%f\n", DDrawCfg.fBlitOff);   break;
	case GDK_KEY_2: DDrawCfg.fBlitOff   += 0.05; printf("%f\n", DDrawCfg.fBlitOff);   break;
	case GDK_KEY_3: DDrawCfg.fTexIndent -= 0.05; printf("%f\n", DDrawCfg.fTexIndent); break;
	case GDK_KEY_4: DDrawCfg.fTexIndent += 0.05; printf("%f\n", DDrawCfg.fTexIndent); break;
	}
#endif
